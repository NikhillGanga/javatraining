...
public class TravelInsurance implements Policy {
	 ...
	 int policyNumber;
	  ...
	  double basePremium;
	   ...
	   public TravelInsurance(int policyNumber, String customerName, int customerAge, double basePremium,
			PolicyStatus policyStatus) {
		super();
	   ...
	   public double calculationRule() {
		...
		return basePremium+(basePremium*0.10);
	   }
